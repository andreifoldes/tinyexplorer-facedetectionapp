#!/usr/bin/env python3
"""
Test specific YOLO model to debug loading issue
"""
...
if __name__ == "__main__":
    # Test the failing models
    failing_models = ["yolov8m-face.pt", "yolov8l-face.pt", "yolov11m-face.pt", "yolov12l-face.pt"]
    
    for model in failing_models[:2]:  # Test first two
        print(f"\n{'='*60}")
